//program
/*
Source - https://www.youtube.com/user/18F4550videos/videos
*/
...
//////////////////////////////////////////////////////////
void main(void){
	 TRISBbits.TRISB0 = 0; //pinMode to output
	 TRISBbits.TRISB1 = 0;
	 TRISBbits.TRISB2 = 0;


	while(1){
		PORTBbits.RB0 = 1; //digitalWrite pin to HIGH
		PORTBbits.RB1 = 1;
		PORTBbits.RB2 = 1;

		delay();

		PORTBbits.RB0 = 0; //digitalWrite pin to LOW
		PORTBbits.RB1 = 0;
		PORTBbits.RB2 = 0;
